 {
	...
	"translatorType": 3,
	"label": "Bib2HAL",
	"creator": "Simon Kornblith, Richard Karnesky, Emiliano Heyns, Nicolas Alarcon, Stéphane Calderoni", //Simon Kornblith, Richard Karnesky, Emiliano Heyns pour la partie bibtex ; Nicolas Alarcon et Stéphane Calderoni pour la partie bib2hal
	"target": "bib",
	"minVersion": "2.1.9",
	"maxVersion": null,
	"priority": 100,
	...
	"lastUpdated": "2015-06-19 11:42:00"
}
...
var fieldMap = {
	...
	volume:"volume",
	copyright:"rights",
	cote:"callNumber",//l'export du callNumber fonctionne
	archive:"archive",
...
var Bib2HalMap = {
	copyright:"x-proceedings",
	archiveloc:"x-audience",
	archive:"x-onbehalfof",
	catalog:"x-domain",
	cote:"x-peerreviewing",
	shorttitle:"x-conferencestartdate",
	access:"x-conferenceenddate",
	note:"x-localreference",
	language:"x-language"
};
	...
	while(item = Zotero.nextItem()) {
		...
		*/
		...
		for(var field in fieldMap)
		{
			if(item[fieldMap[field]])
			{
				Bib2HalField = Bib2HalMap[field] ? Bib2HalMap[field] : field;
				writeField(Bib2HalField, item[fieldMap[field]]);
			}
		}
		...
		// -------------------------------------------------------
		// bloc spécifique de traitement des articles de colloques
		...
		if(item.publicationTitle) {
			...
			if(item.itemType == "bookSection") {
				...
				writeField("x-source", item.publicationTitle);
			}			
		...
		if(item.extra) {
			...
			if(extra) writeField("x-localreference", extra);
		}
